# Project Cruise v0.11.0-rc5 — Baseline and Promotion Policy

## Decision

The final GitHub test package will be built as **v0.11.0-rc5**.
...
2. `integration-v0.11.0-rc5`: GitHub Pages test candidate.
